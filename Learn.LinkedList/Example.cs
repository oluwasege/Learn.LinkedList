...
using System.Threading.Tasks;
    ...
    public static void CreateLinkedList()
    {
        ...
        Display(sentence, "Test 4: Move the last node to be first node:");
        ...
        // Remove the node referred to by mark1, and then add it before the node referred to by current.
